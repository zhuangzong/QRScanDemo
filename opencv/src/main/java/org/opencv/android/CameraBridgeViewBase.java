...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private void checkCurrentState() {
        ...
        Log.i(TAG,"mEnabled========"+mEnabled);
        Log.i(TAG,"mCameraPermissionGranted========"+mCameraPermissionGranted);
        Log.i(TAG,"mSurfaceExist========"+mSurfaceExist);
        Log.i(TAG,"getVisibility========"+getVisibility());
        if (mEnabled && mCameraPermissionGranted && mSurfaceExist && getVisibility() == VISIBLE) {
            targetState = STARTED;
        } else {
            targetState = STOPPED;
        }
        Log.i(TAG,"state========"+targetState);
